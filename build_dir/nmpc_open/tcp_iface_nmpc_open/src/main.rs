///
/// Auto-generated TCP server for optimizer: nmpc_open
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != NMPC_OPEN_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != NMPC_OPEN_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [nmpc_open]")
        .version("0.0.0")
        .author("John Smith")
